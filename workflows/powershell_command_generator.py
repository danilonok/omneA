...
from core.prompts.prompts import DEFAULT_COMMAND_GENERATION_TMPL
...
class CommandGenerator(BaseGenerator):
    def __init__(self, prompt: Optional[str] = None, model: Optional[str] = None,
                 output_model: Optional[BaseModel] = None) -> List[Command]:
