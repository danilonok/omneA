...
* **Advanced Prompt Augmentation (RAG):** Employs a **Retrieval-Augmented Generation (RAG)** system to enrich the prompts for small, on-device LLMs with high-quality, relevant few-shot examples generated by a **GPT-4o model**.
